...
module monitoring './monitor/monitoring.bicep' = if (useApplicationInsights) {
  name: 'monitoring'
  scope: resourceGroup
  params: {
    location: location
...
module backend './host/appservice.bicep' = {
  ...
  params: {
    ...
    runtimeName: 'python'
    runtimeVersion: '3.11'
    appCommandLine: 'export FLASK_APP=app.py && flask run'
...
// SYSTEM IDENTITIES
module openAiRoleBackend './security/role.bicep' = {
  scope: openAiResourceGroup
